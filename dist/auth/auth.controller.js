...
let AuthController = class AuthController {
    ...
    signUp1(createAdminDto) {
        return this.authService.AdminsignUp(createAdminDto);
    }
    async Usersigon(loginDto) {
        return this.authService.Userlogin(loginDto);
    }
    async Adminsigon(loginDto) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AuthController.prototype, "signUp1", null);
__decorate([
...
], AuthController.prototype, "Usersigon", null);
__decorate([
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    ...
    __metadata("design:paramtypes", [login_dto_1.LoginDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "Adminsigon", null);
